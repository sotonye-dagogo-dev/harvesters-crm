...
export const updateUserSchema = updateProfileSchema.extend({
  ...
  role: z
    .enum([
      ...
      USER_ROLES.SPO as "SPO",
      USER_ROLES.CHURCH_MINISTRY as "CHURCH_MINISTRY",
      USER_ROLES.GROUP_ADMIN as "GROUP_ADMIN",
      USER_ROLES.GROUP_LEADER as "GROUP_LEADER",
      USER_ROLES.CAMPUS_PASTOR as "CAMPUS_PASTOR",
      USER_ROLES.CAMPUS_LEADER as "CAMPUS_LEADER",
      USER_ROLES.DISTRICT_LEADER as "DISTRICT_LEADER",
      USER_ROLES.COMMUNITY_LEADER as "COMMUNITY_LEADER",
      USER_ROLES.AREA_LEADER as "AREA_LEADER",
      USER_ROLES.ZONE_LEADER as "ZONE_LEADER",
